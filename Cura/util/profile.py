...
setting('machine_center', '', bool, 'machine', 'hidden').setLabel(_("Machine center x,y"), _("Machines firmware defines the center of the bed as x,y instead of the front left corner."))
...
setting('extruder_offset_x0', '0.0', float, 'machine', 'hidden').setLabel(_("Offset X"), _("The offset of your primary extruder."))
setting('extruder_offset_y0', '0.0', float, 'machine', 'hidden').setLabel(_("Offset Y"), _("The offset of your primary extruder."))
setting('extruder_offset_x1', '0.0', float, 'machine', 'hidden').setLabel(_("Offset X"), _("The offset of your secondary extruder."))
setting('extruder_offset_y1', '21.6', float, 'machine', 'hidden').setLabel(_("Offset Y"), _("The offset of your secondary extruder."))
setting('extruder_offset_x2', '0.0', float, 'machine', 'hidden').setLabel(_("Offset X"), _("The offset of your tertiary extruder."))
setting('extruder_offset_y2', '0.0', float, 'machine', 'hidden').setLabel(_("Offset Y"), _("The offset of your tertiary extruder."))
setting('extruder_offset_x3', '0.0', float, 'machine', 'hidden').setLabel(_("Offset X"), _("The offset of your fourth extruder."))
setting('extruder_offset_y3', '0.0', float, 'machine', 'hidden').setLabel(_("Offset Y"), _("The offset of your fourth extruder."))
...
def getMachineCenterCoords():
	...
	center = getMachineSetting('machine_center')
	if center:
		return map(lambda num: float(num), center.split(","))
